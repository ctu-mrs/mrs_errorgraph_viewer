...
namespace mrs_errorgraph_viewer
{
  ...
  struct errorgraph_element_t
  {
    ...
    errorgraph_element_t(node_id_t&& source_node)
  ...
  class Errorgraph
  {
    private:
      ...
      errorgraph_element_t* find_element_mutable(const node_id_t& node_id);
    ...
    public:
      ...
      const errorgraph_element_t* find_element(const node_id_t& node_id);

      const errorgraph_element_t* add_element_from_msg(const errorgraph_element_msg_t& msg);
  };
